...
<main>
    ...
    <section class="relative flex min-h-[650px] flex-col items-center justify-center gap-6 overflow-hidden px-6 py-10">
        ...
        <div class="relative mx-auto max-w-5xl px-6 mb-10 mt-20 text-center text-white">
            <h1
        ...
        <!-- Booking ding -->
        <div class="relative z-10 w-full max-w-5xl rounded-lg bg-white p-5 mt-10 font-sans text-slate-950 shadow-lg">
