<?php 
include __DIR__ . "/../app/page-includes/verwerk-contactformulier.php";
...
<main class="px-6 py-12">
    <section class="mx-auto max-w-4xl">
        ...
        <form class="mt-8 grid gap-4 rounded-md border border-black p-5" action="contact.php" method="post">
            <input class="h-12 rounded-md border border-black px-3 outline-none focus:border-accent" type="text" name="naam" value="<?= $naam ?>" placeholder="Naam">
            <input class="h-12 rounded-md border border-black px-3 outline-none focus:border-accent" type="email" name="email" value="<?= $email ?>" placeholder="E-mail">
            <textarea class="min-h-36 rounded-md border border-black p-3 outline-none focus:border-accent" name="bericht" placeholder="Bericht"><?= $bericht ?></textarea>
