...
$boekingsnummer = "QL" . rand(100, 999);

$stmt = $pdo->prepare("INSERT INTO boekingen
(boekingsnummer, gebruiker_id, reis_id, vlucht_id, klant_naam, klant_email, klant_telefoon, aantal_reizigers, reisklasse, bagage_keuze, totaalprijs, status, opmerkingen)
VALUES
